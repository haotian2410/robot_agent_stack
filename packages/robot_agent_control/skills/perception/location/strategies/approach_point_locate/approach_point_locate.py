"""ApproachPointLocate Strategy skeleton."""
...
class ApproachPointLocate:
    """Generate localization candidates using approach-point generation."""

    strategy_id = "approach_point_locate"
    ...
    def locate(
        ...
        """
        raise NotImplementedError("Implement ApproachPointLocate.locate().")
