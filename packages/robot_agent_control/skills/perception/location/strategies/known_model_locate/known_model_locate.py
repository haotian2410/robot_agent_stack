"""KnownModelLocate Strategy skeleton."""
...
class KnownModelLocate:
    """Generate localization candidates using known-model registration."""

    strategy_id = "known_model_locate"
    ...
    def locate(
        ...
        """
        raise NotImplementedError("Implement KnownModelLocate.locate().")
