"""OcclusionAwareView Strategy skeleton."""
...
class OcclusionAwareView:
    """Generate candidate camera viewpoints for Occlusion-Aware View."""

    strategy_id = "occlusion_aware_view"
    ...
    def generate(
        ...
        """
        raise NotImplementedError("Implement OcclusionAwareView.generate().")
