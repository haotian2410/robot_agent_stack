"""SystematicScan Strategy skeleton."""
...
class SystematicScan:
    """Generate candidate camera viewpoints for Systematic Scan."""

    strategy_id = "systematic_scan"
    ...
    def generate(
        ...
        """
        raise NotImplementedError("Implement SystematicScan.generate().")
