"""LocalViewRefinement Strategy skeleton."""
...
class LocalViewRefinement:
    """Generate candidate camera viewpoints for Local View Refinement."""

    strategy_id = "local_view_refinement"
    ...
    def generate(
        ...
        """
        raise NotImplementedError("Implement LocalViewRefinement.generate().")
